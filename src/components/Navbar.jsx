    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex justify-between items-center h-16">
          {/* Social icons on the left (mobile only) */}
          ...
          >
            <svg width={28} height={28} fill="none" stroke="currentColor" strokeWidth={2} className="text-white">
              <line x1="6" y1="9" x2="22" y2="9" strokeWidth="2" strokeLinecap="round"/>
              <line x1="6" y1="14" x2="22" y2="14" strokeWidth="2" strokeLinecap="round"/>
              <line x1="6" y1="19" x2="22" y2="19" strokeWidth="2" strokeLinecap="round"/>
            </svg>
          </button>
